          ...
          <div className={styles.onecontent}>
            ...
            <div className={styles.parent}>
              ...
              <div className={styles.para}>
                ...
                deals that are relevant to a user's choice. It's also convenient
                for you to fascinate users to your website so they can educate
                themselves more about your line of business.
              </div>
            </div>
          </div>
        </div>
